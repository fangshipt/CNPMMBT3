        ...
        return (
            <div style={{ background: "#F9F3EC", minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div className="text-center">
                    ...
                    <p className="mt-3 text-muted">Vui lòng <Link to="/login">đăng nhập</Link> để xem danh sách yêu thích.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="container py-5">
                <div className="d-flex align-items-center gap-2 mb-4">
                    <h2 className="fw-normal m-0" style={{ color: "#3a2e28" }}>
                        <iconify-icon icon="ph:heart" class="me-2" style={{ color: "#ef4444" }}></iconify-icon>
                        Sản phẩm yêu thích
                    </h2>
                ...
                {wishlist.length === 0 ? (
                    <div className="bg-white rounded-4 shadow-sm p-5 text-center">
                        ...
                        <p className="mt-3 text-muted">Bạn chưa có sản phẩm yêu thích nào.</p>
