...
function PromotionBanner() {
  ...
  useEffect(() => {
    getProductsApi({ isOnSale: "true", sortBy: "-views", limit: 5 })
      .then((res) => {
  ...
  return (
    <section style={{ background: "#fff8f0", padding: "52px 0 36px" }}>
      <div className="container">
        ...
        {loading ? (
          <div className="text-center py-4">
            <div className="spinner-border" style={{ color: "#c8a87a" }} role="status" />
          </div>
        ) : (
