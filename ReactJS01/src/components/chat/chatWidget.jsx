        ...
        <div style={{ position: 'fixed', bottom: 28, right: 28, zIndex: 1000, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 12 }}>
            ...
            {open && (
                <div style={{
                    ...
                    {/* Header */}
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 16px', background: 'linear-gradient(135deg, #3D2B1F, #5a4a3f)', flexShrink: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                            <div style={{ width: 36, height: 36, borderRadius: '50%', background: '#DEAD6F', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1rem', flexShrink: 0 }}>
                                🐾
                            </div>
                            <div>
                                <div style={{ color: '#fff', fontWeight: 600, fontSize: '0.92rem', lineHeight: 1.3 }}>FangShi Pet Shop</div>
                    ...
                    <div style={{
                        ...
                        {messages.length === 0 && (
                            <div style={{ textAlign: 'center', color: '#8a7060', fontSize: '0.85rem', marginTop: 24 }}>
                    ...
                    {/* Input */}
                    <div style={{ display: 'flex', gap: 8, padding: '10px 12px', borderTop: '1px solid #f0e8df', flexShrink: 0, background: '#fff' }}>
                        <Input
                        ...
                        <Button
                            ...
                            onClick={handleSend}
                            loading={sending}
                            style={{ borderRadius: '50%', width: 38, height: 38, padding: 0, flexShrink: 0, background: '#ff6b35', borderColor: '#ff6b35' }}
                        />
                    </div>
                </div>
            )}
